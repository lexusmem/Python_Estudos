...
class Playlist:
    ...
    # Método __getitem__ define/declara
    # um objeto como iterável
    # Chamado de Magic methods
    # Duck Typing
    # Python Date Model
    ...
    # Método __len__ define/declara
    # um objeto como sized
    # Que possuí um tamanho
    # Chamado de Magic methods
    # Duck Typing
    # Python Date Model
    def __len__(self):
...
print(f'{atlanta.nome} está na playlist? '
      f'{atlanta in playlist_fim_de_semana}.')
