    ...
    def __str__(self):
        ...
        representacaoString = "Valor: {} \nMoeda Origem: {} \n"\
            "Moeda Destino {}".format(
                self.extraiValor(), moedaOrigem, moedaDestino)
...
# ============================
url1 = 'https://bytebank.com/cambio?moedaoRigem=moedadestino&moedadestino='\
    'dolar&valor=1500'

url2 = 'https://bytebank.com/cambio?moedaoRigem=moedadestino&moedadestino='\
    'dolar&valor=100'

argumentoUrl = ExtratorArgumentosURL(url1)
argumentoUr2 = ExtratorArgumentosURL(url2)
...
print(id(argumentoUr2))
print(argumentoUrl == argumentoUr2)
