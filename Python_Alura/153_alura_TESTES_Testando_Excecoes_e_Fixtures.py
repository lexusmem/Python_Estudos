...
alex.propoe_lance(leilao, 700.00)
...
# Novos testes no arquivo 'test_usuario'.
# Implementado nova função no método propoe_lance
# para impedir lances com valores acima da carteira
# Criado setup dos testes '@pytest.fixture'
