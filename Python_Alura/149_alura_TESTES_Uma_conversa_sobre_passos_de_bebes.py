...
lance_laura = Lance(laura, 200.00)
...
# Incluído método "propõe" que propõe o encapsulamento
...
# Implementado ajustes na validação de testes referente a validação de
# lances com usuários iguais seguidos.
# TDD desenvolvimento orientado a testes. refatorando o código
# de acordo com os testes realizados.
# Passos de bebes significa a implantação em passo a passo
# implementando e testando partes pequenas do códigos "Baby steps".
#
