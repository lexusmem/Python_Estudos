...
# Criado nova classe herdando
# uma função built-in como classe pai
# Função herdada foi a "list"
...
for programa in playlist_fim_de_semana:
    print(programa)
print(f'{atlanta.nome} está na playlist? {atlanta in playlist_fim_de_semana}.')
