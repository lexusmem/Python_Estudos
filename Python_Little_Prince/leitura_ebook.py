...
# endereço do ebook
arquivo_epub = r"C:\Users\lexus\Documents\Estudos\Python_Little_Prince\The_Little_Prince_by_Antoine_de_Saint.epub"
...
arquivo = open(
    r"C:\Users\lexus\Documents\Estudos\Python_Little_Prince\palavras.txt", "a")

# Imprimir as 200 palavras mais frequentes com tradução
for palavra, contagem in palavras_ordenadas[::-1]:  # [::-1] - reverso
