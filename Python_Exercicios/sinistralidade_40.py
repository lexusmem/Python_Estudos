...
# print (f'O prêmio a ser cobrado é de {premio_cobrar: ,.2f}
# para que o sinistro fique a 40%.')
...
print(f'O prêmio a ser cobrado para uma sinistralidade de{(perc_sin/100): .2%}'
      f' é R${pr_cob: ,.2f}.\n')
